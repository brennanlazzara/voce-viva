  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Phrase of the Day */}
        {dailyPhrase && (
          <div className="bg-gradient-to-r from-emerald-100 via-white to-blue-100 rounded-2xl p-8 mb-12 border border-emerald-200 shadow-lg">
            <div className="text-center">
              ...
              <div className="space-y-3">
                <p className="text-3xl font-bold text-emerald-800 italic">
                  "{dailyPhrase.phrase}"
                </p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-gray-100">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Select a mood and tense to practice</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-lg bg-gray-50 hover:bg-white"
              >
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Click on each card to practice different verb types</p>
          </div>
        ...
        {/* Quick Links */}
        <div className="bg-gradient-to-r from-blue-100 via-white to-purple-100 rounded-2xl p-8 shadow-lg border border-blue-200">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-blue-800 mb-2">
              🚀 Quick Access Links
            </h2>
            <p className="text-blue-600">Jump to specific tenses and moods</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <a
              href="/verb-conjugation/indicativo/presente"
              className="group block bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-100"
            >
              <div className="text-center">
                <div className="text-3xl mb-2">🌟</div>
                <div className="text-blue-600 font-bold text-lg group-hover:text-blue-700">Presente Indicativo</div>
                <div className="text-sm text-gray-600 mt-1">Most common tense</div>
              </div>
            </a>
            <a
            ...
            >
              <div className="text-center">
                <div className="text-3xl mb-2">📅</div>
                <div className="text-green-600 font-bold text-lg group-hover:text-green-700">Passato Prossimo</div>
                <div className="text-sm text-gray-600 mt-1">Past tense</div>
              </div>
            </a>
            <a
            ...
            >
              <div className="text-center">
                <div className="text-3xl mb-2">🎭</div>
                <div className="text-purple-600 font-bold text-lg group-hover:text-purple-700">Congiuntivo Presente</div>
                <div className="text-sm text-gray-600 mt-1">Subjunctive mood</div>
              </div>
            </a>
          </div>
        </div>
