...
function LessonDialog({ isOpen, onClose, tense, mood }: LessonDialogProps) {
  ...
  const getLessonContent = () => {
        ...
        sections: [
          {
            ...
            content: "The Presente Indicativo (Present Indicative) is used to express actions happening now, habitual actions, or general truths.",
            examples: ["Io parlo italiano (I speak Italian)", "Lei studia ogni giorno (She studies every day)"]
          },
          {
            title: "-ARE Verbs (First Conjugation)",
            content: "Remove -are and add: -o, -i, -a, -iamo, -ate, -ano",
            examples: ["parlare → io parlo, tu parli, lui parla, noi parliamo, voi parlate, loro parlano"]
          },
          {
            title: "-ERE Verbs (Second Conjugation)",
            content: "Remove -ere and add: -o, -i, -e, -iamo, -ete, -ono",
            examples: ["vendere → io vendo, tu vendi, lui vende, noi vendiamo, voi vendete, loro vendono"]
          },
          {
            title: "-IRE Verbs (Third Conjugation)",
            content: "Remove -ire and add: -o, -i, -e, -iamo, -ite, -ono",
            examples: ["dormire → io dormo, tu dormi, lui dorme, noi dormiamo, voi dormite, loro dormono"]
          }
        ]
      };
    }
    ...
    return {
      title: `${mood.charAt(0).toUpperCase() + mood.slice(1)} ${tense.charAt(0).toUpperCase() + tense.slice(1)} - Guide`,
      sections: [
        {
          title: "About This Tense",
          content: `The ${mood} ${tense} is an important tense in Italian grammar.`,
          examples: ["This lesson content will be expanded based on the specific tense."]
        }
      ]
    };
  };
          ...
          <div className="p-6 space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-md p-4">
                    ...
                    <ul className="space-y-1">
                      {section.examples.map((example, exIndex) => (
                        <li key={exIndex} className="text-gray-600 font-mono text-sm">
                          • {example}
                        </li>
                      ))}
                    </ul>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <ul className="text-blue-800 space-y-2">
                ...
                <li>• Practice with regular verbs before moving to irregular ones</li>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-white rounded-md p-3">
                    <h5 className="font-medium text-green-800 mb-2">-ARE Verbs</h5>
                  ...
                  <div className="bg-white rounded-md p-3">
                    <h5 className="font-medium text-blue-800 mb-2">-ERE Verbs</h5>
                  ...
                  <div className="bg-white rounded-md p-3">
                    <h5 className="font-medium text-purple-800 mb-2">-IRE Verbs</h5>
