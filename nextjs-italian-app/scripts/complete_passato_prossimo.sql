-- Complete Passato Prossimo Update for Remaining 76 Verbs
-- This script adds Passato Prossimo conjugations to all remaining verbs
-- =============================================
...
-- Final verification
SELECT 'Remaining Passato Prossimo update completed successfully for ' || COUNT(*) || ' additional verbs!' as status
FROM verbs
